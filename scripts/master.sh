...
wget https://s3.amazonaws.com/stratosphere-bootstrap/viirya-hadoop-0.0.4.tar.gz
puppet module install viirya-hadoop-0.0.4.tar.gz
...
wget https://s3.amazonaws.com/stratosphere-bootstrap/certListHostnames.sh 
chmod +x certListHostnames.sh
nohup ./certListHostnames.sh &
